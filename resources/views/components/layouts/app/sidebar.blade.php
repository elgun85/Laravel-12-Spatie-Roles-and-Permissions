            ...
            <flux:navlist.item icon="users" :href="route('users.index')" :current="request()->routeIs('users.index')" wire:navigate>{{ __('Users') }}</flux:navlist.item>
                   ...
                   <flux:navlist.item icon="list-bullet" :href="route('product.index')" :current="request()->routeIs('product.index')" wire:navigate>{{ __('Products') }}</flux:navlist.item>
                    ...
                    @if(auth()->user()->can('permissions.create')||
                        auth()->user()->can('permissions.edit')||
                        auth()->user()->can('permissions.delete')||
                        auth()->user()->can('permissions.view'))
        <flux:navlist.item icon="hand-raised" :href="route('permissions.index')" :current="request()->routeIs('permissions.index')" wire:navigate>{{ __('Permissions ') }}</flux:navlist.item>
                    @endif
